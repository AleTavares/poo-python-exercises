class Aluno:
    ...
    def apresentar(self):
        """Implementação específica de apresentação para Aluno."""
...
class Professor:
    ...
    def apresentar(self):
        """Implementação específica de apresentação para Professor."""
...
class Funcionario:
    ...
    def apresentar(self):
        """Implementação específica de apresentação para Funcionario."""
